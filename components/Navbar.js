...
const Navbar = () => {
	...
	useEffect(() => {
		if (
			router.asPath === "/simplegame" ||
			router.asPath === "/refugee" ||
			router.asPath === "/shootinggame" ||
			router.asPath === "/shootinggame" ||
			router.asPath === "/shootinggame" ||
			router.asPath === "/shootinggame" ||
			router.asPath === "/houseseller" ||
			router.asPath === "/wineshop" ||
			router.asPath === "/cakeshop" ||
			router.asPath === "/Camelot"
		) {
